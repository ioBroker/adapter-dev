...
parser
    ...
    .alias("h", "help")
    .alias("v", "version")
    .command(["translate", "t", "$0"], "Translate io-package.json, jsonConfig and all admin language files", {}, (0, util_1.interceptErrors)(translate_adapter_handlers_1.handleTranslateCommand))
