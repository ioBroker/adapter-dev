...
import { handleBuildAllCommand, handleBuildReactCommand, handleBuildTypeScriptCommand } from './build-adapter-handlers';
...
parser
    ...
    .command(
        ...
        async argv => {
            ...
            await handleBuildAllCommand(argv.watch, reactOptions, typescriptOptions);
        },
    )
